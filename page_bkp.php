...
?>
    ...
    <div class="container">
            ...
            (function (window) {
                ...
                BX.TreeCondCtrlPopup.prototype.PopupShow = function () {
                    ...
                    wnd.onbeforeunload = function () {
                        BX.onCustomEvent('onTreeCondPopupClose')
                    };
                };
                ...
                BX.TreeConditions = function (arParams, obTree, obControls) {
                    ...
                    this.messTree = {
                        ...
                        'CONTROL_DATETIME_ICON': 'Нажмите для выбора даты',
                        'CONDITION_ERROR': 'Ошибка в условии',
                        'CONDITION_FATAL_ERROR': 'Неустранимая ошибка в условии. Рекомендуется его удалить'
                    };
                                ...
                                if (typeof item === 'object') {
                                    ...
                                    if (!!obTreeLevel.visual) {
                                        if (BX.util.in_array(item.id, obTreeLevel.visual.controls)) {
                                            ...
                                            params.events.visual = BX.delegate(function () {
                                                this.ChangeVisual(obTreeLevel);
                                            }, this);
                                        }
                                    }
                                ...
                                if (!!obTreeLevel.children && !!obTreeLevel.children.length && obTreeLevel.children.length > 0) {
                                    if (!!obTreeLevel.visual && typeof (obTreeLevel.visual) === 'object') {
                                        ...
                                        if (-1 < intCurrentIndex) {
                                            ...
                                            obLogicParams.visual = BX.delegate(function () {
                                                this.NextVisual(obTreeLevel);
                                            }, this);
        ...
        <style type="text/css">
            ...
            div.condition-border a,
            div.condition-border a:link,
            div.condition-border a:visited,
            div.condition-container a,
            div.condition-container a:link,
            div.condition-container a:visited {
                color: #113c7d;
            ...
            div.condition-border a:hover,
            div.condition-container a:hover {
                color: #113c7d;
                text-decoration: none;
                cursor: pointer;
            ...
            div.condition-border a:active,
            div.condition-container a:active {
                color: #113c7d;
                text-decoration: none;
                cursor: pointer;
                border-bottom: 1px solid transparent;
            ...
            div.condition-container {
                ...
                -webkit-box-shadow: 0 1px 0 #eceded;
            ...
            div.condition-container div.condition-container {
                box-shadow: 0 1px 0 #dde5e6;
                -webkit-box-shadow: 0 1px 0 #dde5e6;
            ...
            div.condition-container div.condition-container div.condition-container {
                box-shadow: 0 1px 0 #eeeeee;
                -webkit-box-shadow: 0 1px 0 #eeeeee;
                border: 1px solid #caced7;
                border-radius: 4px;
            ...
            div.condition-border span.control-prefix,
            div.condition-container span.control-prefix,
            div.condition-border span.control-string,
            div.condition-container span.control-string {
                white-space: nowrap;
                line-height: 16px;
            }
            ...
            .condition-item-del:before {
                background: url("images/cond-delete.png") no-repeat left top;
                content: '';
                display: inline-block;
                height: 7px;
                vertical-align: middle;
            ...
            .condition-item-del:hover:before {
                background: url("images/cond-delete.png") no-repeat left bottom;
            }
            ...
            .condition-dots:first-child {
                margin-top: 3px;
            }

            div.condition-border div.condition-simple-control {
                padding: 5px 8px 5px 12px;

                box-shadow: inset 0 1px 0 #eceded;
                -webkit-box-shadow: inset 0 1px 0 #eceded;
                border: 1px solid #d8d8d8;
                border-radius: 4px;
                background-color: #f7f9fa;
                background-image: -webkit-linear-gradient(top, #fafbfc, #f8f9fa);
                background-image: -moz-linear-gradient(top, #fafbfc, #f8f9fa);
            ...
            div.condition-container div.condition-simple-control {
                padding: 5px 8px 5px 12px;

                box-shadow: inset 0 1px 0 #dde5e6;
                -webkit-box-shadow: inset 0 1px 0 #dde5e6;
            ...
            div.condition-container div.condition-container div.condition-simple-control {
                box-shadow: inset 0 1px 0 #cedadc;
                -webkit-box-shadow: inset 0 1px 0 #cedadc;
            ...
            div.condition-simple-control a,
            div.condition-simple-control a:link,
            div.condition-simple-control a:visited,
            div.condition-simple-control a,
            div.condition-simple-control a:link,
            div.condition-simple-control a:visited {
                color: #000000;
            ...
            div.condition-simple-control a:hover,
            div.condition-simple-control a:active,
            ...
            div.condition-simple-control span.control-prefix {
                display: inline-block;
            ...
            div.condition-add a,
            div.condition-add a:link,
            div.condition-add a:visited {
                color: #113c7d;
                text-decoration: none;
                cursor: pointer;
                border-bottom: 1px dashed #113c7d;
            ...
            div.condition-delete {
                float: right;
                width: 7px;
                height: 7px;
                background: transparent url("images/cond-delete.png") no-repeat scroll left top;
                cursor: pointer;
                display: none;
                margin: 5px -10px 0 0;
                padding: 0;
            ...
            div.condition-delete:hover {
                background: transparent url("images/cond-delete.png") no-repeat scroll left bottom;
            }

            div.condition-border div.condition-simple-control div.condition-delete {
                margin: 5px 0 0 0;
            }

            div.condition-group-sep {
                margin: 0 0 10px 0;
                font-size: 0.1em;
                line-height: 0.1em;
            }
            ...
            div.condition-logic-and {
                background-color: #9cbd6d;
            }

            div.condition-logic-or {
            ...
            span.list-alert {
                ...
                width: 26px;
                height: 17px;
                background: transparent url("images/cond-alert.png") no-repeat scroll left top;
        ...
        <form id="post_form" method="post">
            ...
            $obCond = new \CondTree();
            $boolCond = $obCond->Init(LOCAL_CORE_CONDITION_MODE_GENERATE, LOCAL_CORE_CONDITION_BUILD_CATALOG);
            $parsedCondition = $obCond->Parse($request->getPost("module_feed_export_condition_PHP_RULES")); // Это само условие
            $phpCondition = $obCond->Generate($parsedCondition, ['FIELD' => '#VARIABLE_NAME#']);
            ...
            $boolCond = $obCond->Init(LOCAL_CORE_CONDITION_MODE_DEFAULT, LOCAL_CORE_CONDITION_BUILD_CATALOG, [
                "FORM_NAME" => 'post_form', // ID формы в которую будет выводится
                "CONT_ID" => 'module_feed_export_condition_PHP_RULES',
                "JS_NAME" => "JSCatCond",
                "PREFIX" => 'module_feed_export_condition_PHP_RULES'
            ]);
            ...
            if (!$boolCond) {
                ...
                $result .= $obCond->Show($parsedCondition ?? []);
            }

            # Блок с правилами
            $result .= "<div id='module_feed_export_condition_PHP_RULES' style='position: relative; z-index: 1;'></div>";

            echo $result;
            ?>
            <button>ww</button>

            <? dump(\Bitrix\Main\Application::getInstance()
                ->getContext()
                ->getRequest()
                ->getPost('module_feed_export_condition_PHP_RULES')) ?>

            <?
            dump($parsedCondition);
            dump($phpCondition);
            ...
            (
                (
                    (
                        (
                            isset($arName['PARENT_WBL_TEST_CODE']) ? (
                                (
                                    isset($arName['WBL_TEST_CODE'])
                                    && ( $arName['WBL_TEST_CODE'] == "1212")
                                )
                                || $arName['PARENT_WBL_TEST_CODE'] == "1212"
                            ) : (
                                    isset($arName['WBL_TEST_CODE'])
                                    && ($arName['WBL_TEST_CODE'] == "1212")
                            )
