...
?>
<div class="col-12">
    <h2>Пример структуры Robofeed XML</h2>
    <h4>Требования к Robofeed-файлу</h4>
    <ol>
        <li>
            Допустимые кодировки Robofeed-файла: UTF-8, windows-1251.
        </li>
        <li>
            В Robofeed-файле нельзя использовать непечатаемые символы с ASCII-кодами от 0 до 31 (за исключением символов с кодами 9, 10, 13 — табуляция, перевод строки, возврат каретки).
        </li>
        <li>
    ...
    <h4>Правочники Robofeed-файла</h4>
    <ul>
