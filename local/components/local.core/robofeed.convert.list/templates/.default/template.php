    ...
    <table class="table">
        ...
        <tr class="<?=$strStatusColor?>">
            ...
            <td>
                ...
                {
                    case 'SU':
                        echo '<br/><a class="btn btn-warning" href="'.\Bitrix\Main\Application::getInstance()->getContext()->getRequest()->getRequestedPageDirectory().'/?getFile='.urlencode(\Local\Core\Inner\BxModified\CFile::GetPath($arItem['EXPORT_FILE_ID'])).'" target="_blank">Скачать файл</a>';
                        break;
                    case 'ER':
                        ...
                        {
                            echo '<br/>Ваш файл содержит не все необходимые нам данные, из-за чего мы не смогли сконвертировать его в Robofeed XML. Изучите <a href="'.Route::getRouteTo('development', 'robofeed').'" target="_blank">как сделать Robofeed XML</a>.<br/>
