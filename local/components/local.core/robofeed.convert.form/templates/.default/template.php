...
<div class="alert alert-warning" role="alert">
    Стоит понимать, что конвертер пытается создать Robofeed XML на основании других форматов, структура которых отличается от стуктуры, необходимой Robofeed XML.<br/>
    ...
    Данный функционал сделан с целью провести быстрое тестирование функционала и возможностей нашего сервиса.<br/>
