...
<div class="col-12">
            ...
            <div class="media">
                <div class="media-body">
                    <div class="pull-right">
                        <a href="<?=\Local\Core\Inner\Route::getRouteTo('site', 'edit', [
                            '#COMPANY_ID#' => $arParams['COMPANY_ID'],
                            '#SITE_ID#' => $arItem['ID']
                        ])?>" title="Редактировать">
                            <ion-icon name="create"></ion-icon>
                        </a>
                        <a href="<?=\Local\Core\Inner\Route::getRouteTo('site', 'delete', [
                            '#COMPANY_ID#' => $arParams['COMPANY_ID'],
                            '#SITE_ID#' => $arItem['ID']
                        ])?>" title="Удалить">
                    ...
                    <h5 class="mt-0">
                        <a href="<?=\Local\Core\Inner\Route::getRouteTo('site', 'detail', [
                            '#COMPANY_ID#' => $arParams['COMPANY_ID'],
                            '#SITE_ID#' => $arItem['ID']
    ...
    <a href="<?=\Local\Core\Inner\Route::getRouteTo('site', 'add', ['#COMPANY_ID#' => $arParams['COMPANY_ID']])?>" class="btn btn-warning">+
        Добавить сайт</a>
