class PersonalTradingplatformListComponent {
    ...
    {
        swal({
            html: '<p class="text-left">Ваша ссылка на экспортный файл:<br/><br/><b class="text-warning">'+strLinkText+'</b><br/><br/>Укажите эту ссылку в настройках выбранной торговой площадки, как ссылку на прайс-лист или список нуменклатуры.</p>'
        });
    }
}