...
if ($arParams['STORE_ID'] > 0) {
    ...
    \Local\Core\Inner\Route::fillRouteBreadcrumbs('store', 'edit', ['COMPANY_ID' => $arParams['COMPANY_ID'], 'STORE_ID' => $arParams['STORE_ID']]);

    $APPLICATION->SetTitle('Редактирование магазина');
    $APPLICATION->SetPageProperty('title', 'Редактирование магазина');
} else {
