...
$APPLICATION->AddChainItem("Редактирование ".\Local\Core\Inner\Site\Base::getSiteDomain($arParams['SITE_ID']), \Local\Core\Inner\Route::getRouteTo('site', 'edit', [
    '#COMPANY_ID#' => $arParams['COMPANY_ID'],
    '#SITE_ID#' => $arParams['SITE_ID']
]));

$APPLICATION->SetTitle('Редактирование сайта');
$APPLICATION->SetPageProperty('title', 'Редактирование сайта');