 ...
 * @var array                          $arParams
 * @var array                          $arResult
 * @var \PersonalSupportAdminComponent $component
        ...
        <div class="listview listview--hover">
            <div class="scrollbar-inner">
                ...
                <? foreach ($arResult['SUPPORT_LIST'] as $arItem): ?>
                    <a class="listview__item" href="<?=\Local\Core\Inner\Route::getRouteTo('support-admin', 'detail', ['#SUPPORT_ID#' => $arItem['ID']])?>">
                            ...
                            <p>
                                ...
                                <? if (!empty($arItem['LAST_WRITER'])): ?>
                                    ...
                                    switch ($arItem['LAST_WRITER']) {
                                        case 'US':
                                            ?><span class="badge badge-warning">Пользователя</span><?
                                            break;
                                        case 'AD':
                                            ?><span class="badge badge-light">Агента</span><?
                                            break;
                                    }
                                    ?>
                                <? endif; ?>
            ...
            <div class="scrollbar-inner">
                ...
                <div class="message__history">
                    <? foreach ($arResult['SUPPORT_MSG'] as $arItem): ?>
                        <div class="messages__item <?=($arItem['OWN'] == 'US' ? 'messages__item--right' : '')?>">
                            <? if ($arItem['OWN'] == 'AD'): ?>
...
<script type="text/javascript">
    ...
    PersonalSupportComponent.setSupportListUrl('<?=\Local\Core\Inner\Route::getRouteTo('support-admin', 'list')?>');
</script>