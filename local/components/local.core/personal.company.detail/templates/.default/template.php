...
<div class="alert <?= $strAlertClass ?>">
    <div class="pull-right">
        <a href="<?= \Local\Core\Inner\Route::getRouteTo( 'company', 'edit',
            ['#COMPANY_ID#' => $arResult[ 'COMPANY' ][ 'ID' ]] ) ?>" title="Редактировать">
            <ion-icon name="create"></ion-icon>
        </a>
        <a href="<?= \Local\Core\Inner\Route::getRouteTo( 'company', 'delete',
            ['#COMPANY_ID#' => $arResult[ 'COMPANY' ][ 'ID' ]] ) ?>" title="Удалить">
...
<a href="<?= \Local\Core\Inner\Route::getRouteTo( 'bill', 'list',
    ['#COMPANY_ID#' => $arResult[ 'COMPANY' ][ 'ID' ]] ) ?>" class="btn btn-warning">
