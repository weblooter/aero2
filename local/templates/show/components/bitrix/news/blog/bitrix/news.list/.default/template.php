    ...
    <?foreach ($arResult["ITEMS"] as $arRow):?>
        <div class="row">
            <?foreach ($arRow as $arItem):?>
                ...
                $arItem["PREVIEW_PICTURE"]["SRC"] = \CFile::ResizeImageGet($arItem["PREVIEW_PICTURE"]["ID"], ['width' => 1280, 'height' => 200], BX_RESIZE_IMAGE_PROPORTIONAL, false, false, false, 75);
                $arItem["PREVIEW_PICTURE"]["SRC"] = $arItem["PREVIEW_PICTURE"]["SRC"]['src'];
                ?>
