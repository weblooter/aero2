        ...
        <div class="steps row">
            ...
            <div class="col-md-3 col-sm-6">
                <div class="step">
                    ...
                    <p>Для того, чтобы наша система смогла получать информацию о Ваших торговых предожениях, необходимо провести разовую интеграцию Вашего магазина с нашим сервисом.</p>
                </div>
            </div>
            <div class="col-md-3 col-sm-6">
                <div class="step">
            ...
            <div class="col-md-3 col-sm-6">
                <div class="step">
                    ...
                    <p>
                        Дождитесь окончания формирования экпортного файла и укажите ссылку на него в настройках торговой площадки. Готово! Теперь мы будем следить за актуализацией информации о Ваших товаров.
                    </p>
                </div>
            </div>
            <div class="stepsbtn">
