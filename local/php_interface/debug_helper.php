...
function p($value, $die = false, $bHtml = true)
{
    ...
    if (defined("STDIN")) {
        ...
        echo "<pre data-source=\"" . substr($debug_backtrace[0]["file"], strlen($_SERVER["DOCUMENT_ROOT"])) . ":" . $debug_backtrace[0]["line"] . "\" style=\"text-align:left;overflow:auto; color: #000; background-color: white; border: 1px solid #CCC; padding: 5px; font-size: 12px; line-height: 18px;\">" . $sReturn . "</pre>";
