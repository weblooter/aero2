...
class FilterHandler extends AbstractHandler
{
     ...
     * @param int|array                 $minLevelOrList A list of levels to accept or a minimum level if maxLevel is
     *     provided
     ...
     *     is provided
     * @param int|string       $maxLevel Maximum level or level name to accept, only used if $minLevelOrList is not an
     *     array
     */
