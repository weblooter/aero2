...
class DeduplicationHandler extends BufferHandler
{
     ...
     * @param int              $deduplicationLevel The minimum logging level for log records to be looked at for
     *     deduplication purposes
     * @param int              $time The period (in seconds) during which duplicate entries should be suppressed after
     *     a given log is sent through
