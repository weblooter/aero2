...
class TypedReference extends Reference
{
    ...
    public function __construct( string $id, string $type, $invalidBehavior = ContainerInterface::EXCEPTION_ON_INVALID_REFERENCE )
    {
        ...
        {
            @trigger_error( sprintf( 'The $requiringClass argument of "%s()" is deprecated since Symfony 4.1.',
    ...
    public function canBeAutoregistered()
    {
        ...
        return $this->requiringClass && ( false !== $i = strpos( $this->type,
                    '\\' ) ) && 0 === strncasecmp( $this->type, $this->requiringClass, 1 + $i );
    }
}
