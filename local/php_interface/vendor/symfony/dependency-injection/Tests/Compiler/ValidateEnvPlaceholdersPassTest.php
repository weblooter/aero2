...
class ValidateEnvPlaceholdersPassTest extends TestCase
{
     ...
     * @expectedExceptionMessage Invalid type for path "env_extension.bool_node". Expected "bool", but got one of
     ...
     * @expectedExceptionMessage A dynamic value is not compatible with a
     *     "Symfony\Component\Config\Definition\EnumNode" node type at path "env_extension.enum_node".
     */
     ...
     * @expectedException \Symfony\Component\Config\Definition\Exception\InvalidConfigurationException
     * @expectedExceptionMessage A dynamic value is not compatible with a
     *     "Symfony\Component\Config\Definition\ArrayNode" node type at path "env_extension.simple_array_node".
     */
    ...
    public function testNormalizedEnvIsCompatibleWithArrayNode()
    {
        ...
        $this->assertSame( ['array_node' => ['child_node' => $expected]],
