...
class ResolveClassPassTest extends TestCase
{
     ...
     * @expectedExceptionMessage Service definition "App\Foo\Child" has a parent but no class, and its name looks like
     *     a FQCN. Either the class is missing or you want to inherit it from the parent service. To resolve this
     *     ambiguity, please rename this service to a non-FQCN (e.g. using dots), or create the missing class.
     */
