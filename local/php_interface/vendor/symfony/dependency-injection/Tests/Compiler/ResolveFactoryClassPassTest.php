...
class ResolveFactoryClassPassTest extends TestCase
{
     ...
     * @expectedExceptionMessage The "factory" service is defined to be created by a factory, but is missing the
     *     factory class. Did you forget to define the factory or service class?
     */
