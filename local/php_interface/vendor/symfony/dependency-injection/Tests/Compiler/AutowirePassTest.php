...
class AutowirePassTest extends TestCase
{
     ...
     * @expectedExceptionMessage Cannot autowire service "c": argument "$a" of method
     *     "Symfony\Component\DependencyInjection\Tests\Compiler\C::__construct()" references class
     *     "Symfony\Component\DependencyInjection\Tests\Compiler\A" but no such service exists. You should maybe alias
     *     this class to the existing "Symfony\Component\DependencyInjection\Tests\Compiler\B" service.
     */
    ...
    /**
     * @expectedException \Symfony\Component\DependencyInjection\Exception\RuntimeException
     * @expectedExceptionMessage Cannot autowire service "g": argument "$d" of method
     *     "Symfony\Component\DependencyInjection\Tests\Compiler\G::__construct()" references interface
     *     "Symfony\Component\DependencyInjection\Tests\Compiler\DInterface" but no such service exists. You should
     *     maybe alias this interface to the existing "Symfony\Component\DependencyInjection\Tests\Compiler\F" service.
     */
     ...
     * @expectedExceptionMessage Invalid service "private_service": constructor of class
     *     "Symfony\Component\DependencyInjection\Tests\Compiler\PrivateConstructor" must be public.
     */
    ...
    /**
     * @expectedException \Symfony\Component\DependencyInjection\Exception\AutowiringFailedException
     * @expectedExceptionMessage Cannot autowire service "a": argument "$collision" of method
     *     "Symfony\Component\DependencyInjection\Tests\Compiler\CannotBeAutowired::__construct()" references interface
     *     "Symfony\Component\DependencyInjection\Tests\Compiler\CollisionInterface" but no such service exists. You
     *     should maybe alias this interface to one of these existing services: "c1", "c2", "c3".
     */
    ...
    /**
     * @expectedException \Symfony\Component\DependencyInjection\Exception\AutowiringFailedException
     * @expectedExceptionMessage Cannot autowire service "a": argument "$k" of method
     *     "Symfony\Component\DependencyInjection\Tests\Compiler\NotGuessableArgument::__construct()" references class
     *     "Symfony\Component\DependencyInjection\Tests\Compiler\Foo" but no such service exists. You should maybe
     *     alias this class to one of these existing services: "a1", "a2".
     */
     ...
     * @expectedException \Symfony\Component\DependencyInjection\Exception\AutowiringFailedException
     * @expectedExceptionMessage Cannot autowire service "a": argument "$k" of method
     *     "Symfony\Component\DependencyInjection\Tests\Compiler\NotGuessableArgumentForSubclass::__construct()"
     *     references class "Symfony\Component\DependencyInjection\Tests\Compiler\A" but no such service exists. You
     *     should maybe alias this class to one of these existing services: "a1", "a2".
     */
     ...
     * @expectedExceptionMessage Cannot autowire service "a": argument "$collision" of method
     *     "Symfony\Component\DependencyInjection\Tests\Compiler\CannotBeAutowired::__construct()" references interface
     *     "Symfony\Component\DependencyInjection\Tests\Compiler\CollisionInterface" but no such service exists.
     */
    ...
    /**
     * @expectedException \Symfony\Component\DependencyInjection\Exception\AutowiringFailedException
     * @expectedExceptionMessage Cannot autowire service "coop_tilleuls": argument "$j" of method
     *     "Symfony\Component\DependencyInjection\Tests\Compiler\LesTilleuls::__construct()" references class
     *     "Symfony\Component\DependencyInjection\Tests\Compiler\Dunglas" but no such service exists.
     */
    ...
    /**
     * @expectedException \Symfony\Component\DependencyInjection\Exception\AutowiringFailedException
     * @expectedExceptionMessage Cannot autowire service "a": argument "$r" of method
     *     "Symfony\Component\DependencyInjection\Tests\Compiler\BadTypeHintedArgument::__construct()" has type
     *     "Symfony\Component\DependencyInjection\Tests\Compiler\NotARealClass" but this class was not found.
     */
     ...
     * @expectedException \Symfony\Component\DependencyInjection\Exception\AutowiringFailedException
     * @expectedExceptionMessage Cannot autowire service "a": argument "$r" of method
     *     "Symfony\Component\DependencyInjection\Tests\Compiler\BadParentTypeHintedArgument::__construct()" has type
     *     "Symfony\Component\DependencyInjection\Tests\Compiler\OptionalServiceClass" but this class is missing a
     *     parent class (Class Symfony\Bug\NotExistClass not found).
     */
    ...
    /**
     * @expectedException \Symfony\Component\DependencyInjection\Exception\AutowiringFailedException
     * @expectedExceptionMessage Cannot autowire service "bar": argument "$foo" of method
     *     "Symfony\Component\DependencyInjection\Tests\Compiler\Bar::__construct()" references class
     *     "Symfony\Component\DependencyInjection\Tests\Compiler\Foo" but this service is abstract. You should maybe
     *     alias this class to the existing "foo" service.
     */
    ...
    /**
     * @expectedException \Symfony\Component\DependencyInjection\Exception\AutowiringFailedException
     * @expectedExceptionMessage Cannot autowire service "arg_no_type_hint": argument "$bar" of method
     *     "Symfony\Component\DependencyInjection\Tests\Compiler\MultipleArguments::__construct()" is type-hinted
    ...
    /**
     * @expectedException \Symfony\Component\DependencyInjection\Exception\AutowiringFailedException
     * @expectedExceptionMessage Cannot autowire service "arg_no_type_hint": argument "$foo" of method
     *     "Symfony\Component\DependencyInjection\Tests\Compiler\MultipleArguments::__construct()" has no type-hint,
    ...
    public function testOptionalScalarNotReallyOptionalUsesDefaultValue()
    {
        ...
        $definition = $container->register( 'not_really_optional_scalar',
            __NAMESPACE__.'\MultipleArgumentsOptionalScalarNotReallyOptional' )
            ->setAutowired( true );
    ...
    /**
     * @expectedException \Symfony\Component\DependencyInjection\Exception\AutowiringFailedException
     * @expectedExceptionMessage Cannot autowire service "my_service": argument "$i" of method
     *     "Symfony\Component\DependencyInjection\Tests\Compiler\K::__construct()" references interface
     *     "Symfony\Component\DependencyInjection\Tests\Compiler\IInterface" but no such service exists. Did you create
    ...
    {
        $container = new ContainerBuilder();
        $container->register( 'deprecated',
            'Symfony\Component\DependencyInjection\Tests\Fixtures\DeprecatedClass' )->setDeprecated( true );
        $container->register( 'foo', __NAMESPACE__.'\Foo' );
        $container->register( 'bar', __NAMESPACE__.'\Bar' )->setAutowired( true );
    ...
    public function provideNotWireableCalls()
    {
        return [
            [
                'setNotAutowireable',
                'Cannot autowire service "foo": argument "$n" of method "Symfony\Component\DependencyInjection\Tests\Compiler\NotWireable::setNotAutowireable()" has type "Symfony\Component\DependencyInjection\Tests\Compiler\NotARealClass" but this class was not found.'
            ],
            [
                'setDifferentNamespace',
                'Cannot autowire service "foo": argument "$n" of method "Symfony\Component\DependencyInjection\Tests\Compiler\NotWireable::setDifferentNamespace()" references class "stdClass" but no such service exists.'
            ],
            [
                null,
                'Invalid service "foo": method "Symfony\Component\DependencyInjection\Tests\Compiler\NotWireable::setProtectedMethod()" must be public.'
            ],
        ];
    }
    ...
    /**
     * @expectedException \Symfony\Component\DependencyInjection\Exception\AutowiringFailedException
     * @expectedExceptionMessage Cannot autowire service "foo": argument "$sam" of method
     *     "Symfony\Component\DependencyInjection\Tests\Compiler\NotWireable::setNotAutowireableBecauseOfATypo()"
     *     references class "Symfony\Component\DependencyInjection\Tests\Compiler\lesTilleuls" but no such service
     *     exists. Did you mean "Symfony\Component\DependencyInjection\Tests\Compiler\LesTilleuls"?
     */
    ...
    /**
     * @expectedException \Symfony\Component\DependencyInjection\Exception\AutowiringFailedException
     * @expectedExceptionMessage Cannot autowire service "j": argument "$i" of method
     *     "Symfony\Component\DependencyInjection\Tests\Compiler\J::__construct()" references class
     *     "Symfony\Component\DependencyInjection\Tests\Compiler\I" but no such service exists. Try changing the
     *     type-hint to "Symfony\Component\DependencyInjection\Tests\Compiler\IInterface" instead.
     */
     ...
     * @expectedExceptionMessage Cannot autowire service "j": argument "$i" of method
     *     "Symfony\Component\DependencyInjection\Tests\Compiler\J::__construct()" references class
     *     "Symfony\Component\DependencyInjection\Tests\Compiler\I" but no such service exists. You should maybe alias
     *     this class to one of these existing services: "i", "i2".
     */
    ...
    /**
     * @expectedException \Symfony\Component\DependencyInjection\Exception\AutowiringFailedException
     * @expectedExceptionMessage Cannot autowire service
     *     "Symfony\Component\DependencyInjection\Tests\Compiler\NonAutowirableDecorator": argument "$decorated1" of
     *     method "__construct()" references interface
     *     "Symfony\Component\DependencyInjection\Tests\Compiler\DecoratorInterface" but no such service exists. You
     *     should maybe alias this interface to one of these existing services:
     *     "Symfony\Component\DependencyInjection\Tests\Compiler\NonAutowirableDecorator",
     *     "Symfony\Component\DependencyInjection\Tests\Compiler\NonAutowirableDecorator.inner".
     */
    ...
    public function testErroredServiceLocator()
    {
        ...
        $container->register( 'some_locator', 'stdClass' )
            ->addArgument( new TypedReference( MissingClass::class, MissingClass::class,
                ContainerBuilder::RUNTIME_EXCEPTION_ON_INVALID_REFERENCE ) )
        ...
        $this->assertEquals( $erroredDefinition->addError( 'Cannot autowire service "some_locator": it has type "Symfony\Component\DependencyInjection\Tests\Compiler\MissingClass" but this class was not found.' ),
            $container->getDefinition( '.errored.some_locator.'.MissingClass::class ) );
    }
}
