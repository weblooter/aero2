...
class ResolveInstanceofConditionalsPassTest extends TestCase
{
    public function testProcess()
    {
        ...
        $def->setInstanceofConditionals( [
            parent::class => ( new ChildDefinition( '' ) )->setProperty( 'foo', 'bar' )->addTag( 'baz',
                ['attr' => 123] ),
        ] );
     ...
     * @expectedExceptionMessage Autoconfigured instanceof for type "PHPUnit\Framework\TestCase" defines arguments but
     *     these are not supported and should be removed.
     */
