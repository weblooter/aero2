...
class GraphvizDumperTest extends TestCase
{
    ...
    public function testDump()
    {
        ...
        $this->assertStringEqualsFile( self::$fixturesPath.'/graphviz/services1.dot', $dumper->dump(),
            '->dump() dumps an empty container as an empty dot file' );

        $container = include self::$fixturesPath.'/containers/container9.php';
        $dumper = new GraphvizDumper( $container );
        $this->assertStringEqualsFile( self::$fixturesPath.'/graphviz/services9.dot', $dumper->dump(),
            '->dump() dumps services' );

        $container = include self::$fixturesPath.'/containers/container10.php';
        $dumper = new GraphvizDumper( $container );
        $this->assertStringEqualsFile( self::$fixturesPath.'/graphviz/services10.dot', $dumper->dump(),
            '->dump() dumps services' );
    ...
    public function testDumpWithFrozenContainer()
    {
        ...
        $dumper = new GraphvizDumper( $container );
        $this->assertStringEqualsFile( self::$fixturesPath.'/graphviz/services13.dot', $dumper->dump(),
            '->dump() dumps services' );
    }
    ...
    public function testDumpWithFrozenCustomClassContainer()
    {
        ...
        $dumper = new GraphvizDumper( $container );
        $this->assertStringEqualsFile( self::$fixturesPath.'/graphviz/services14.dot', $dumper->dump(),
            '->dump() dumps services' );
    }
    ...
    public function testDumpWithUnresolvedParameter()
    {
        ...
        $this->assertStringEqualsFile( self::$fixturesPath.'/graphviz/services17.dot', $dumper->dump(),
            '->dump() dumps services' );
    }
    ...
    public function testDumpWithInlineDefinition()
    {
        ...
        $this->assertStringEqualsFile( self::$fixturesPath.'/graphviz/services_inline.dot', $dumper->dump(),
            '->dump() dumps nested references' );
    }
}
