...
class PhpDumperTest extends TestCase
{
    ...
    public function testDump()
    {
        ...
        $this->assertStringEqualsFile( self::$fixturesPath.'/php/services1.php', $dumper->dump(),
            '->dump() dumps an empty container as an empty PHP class' );
        $this->assertStringEqualsFile( self::$fixturesPath.'/php/services1-1.php', $dumper->dump( [
            'class' => 'Container',
    ...
    public function testDumpOptimizationString()
    {
        ...
        $dumper = new PhpDumper( $container );
        $this->assertStringEqualsFile( self::$fixturesPath.'/php/services10.php', $dumper->dump(),
            '->dump() dumps an empty container as an empty PHP class' );
    }
    ...
    public function testDumpRelativeDir()
    {
        ...
        $dumper = new PhpDumper( $container );
        $this->assertStringEqualsFile( self::$fixturesPath.'/php/services12.php', $dumper->dump( ['file' => __FILE__] ),
    ...
    public function testDumpCustomContainerClassWithoutConstructor()
    {
        ...
        $this->assertStringEqualsFile( self::$fixturesPath.'/php/custom_container_class_without_constructor.php',
            $dumper->dump( [
                'base_class' => 'NoConstructorContainer',
    ...
    public function testDumpCustomContainerClassConstructorWithoutArguments()
    {
        ...
        $this->assertStringEqualsFile( self::$fixturesPath.'/php/custom_container_class_constructor_without_arguments.php',
            $dumper->dump( [
                'base_class' => 'ConstructorWithoutArgumentsContainer',
                'namespace' => 'Symfony\Component\DependencyInjection\Tests\Fixtures\Container'
            ] ) );
    }
    ...
    public function testDumpCustomContainerClassWithOptionalArgumentLessConstructor()
    {
        ...
        $this->assertStringEqualsFile( self::$fixturesPath.'/php/custom_container_class_with_optional_constructor_arguments.php',
            $dumper->dump( [
                'base_class' => 'ConstructorWithOptionalArgumentsContainer',
                'namespace' => 'Symfony\Component\DependencyInjection\Tests\Fixtures\Container'
            ] ) );
    }
    ...
    public function testDumpCustomContainerClassWithMandatoryArgumentLessConstructor()
    {
        ...
        $this->assertStringEqualsFile( self::$fixturesPath.'/php/custom_container_class_with_mandatory_constructor_arguments.php',
            $dumper->dump( [
                'base_class' => 'ConstructorWithMandatoryArgumentsContainer',
                'namespace' => 'Symfony\Component\DependencyInjection\Tests\Fixtures\Container'
            ] ) );
    }
    ...
    public function testAddParameters()
    {
        ...
        $container->compile();
        $dumper = new PhpDumper( $container );
        $this->assertStringEqualsFile( self::$fixturesPath.'/php/services8.php', $dumper->dump(),
            '->dump() dumps parameters' );
    }
    ...
    public function testAddService()
    {
        ...
        $container->compile();
        $dumper = new PhpDumper( $container );
        $this->assertStringEqualsFile( self::$fixturesPath.'/php/services9_compiled.php',
            str_replace( str_replace( '\\', '\\\\',
                self::$fixturesPath.\DIRECTORY_SEPARATOR.'includes'.\DIRECTORY_SEPARATOR ), '%path%', $dumper->dump() ),
            '->dump() dumps services' );
        ...
        {
            $this->assertInstanceOf( '\Symfony\Component\DependencyInjection\Exception\RuntimeException', $e,
                '->dump() throws a RuntimeException if the container to be dumped has reference to objects or resources' );
            $this->assertEquals( 'Unable to dump a service container if a parameter is an object or a resource.',
                $e->getMessage(),
                '->dump() throws a RuntimeException if the container to be dumped has reference to objects or resources' );
        }
    }
    ...
    public function testServicesWithAnonymousFactories()
    {
        ...
        $this->assertStringEqualsFile( self::$fixturesPath.'/php/services19.php', $dumper->dump(),
            '->dump() dumps services with anonymous factories' );
    }
    ...
    public function testOverrideServiceWhenUsingADumpedContainer()
    {
        ...
        $this->assertSame( $decorator, $container->get( 'decorator_service' ),
            '->set() overrides an already defined service' );
    }
    ...
    public function testEnvParameter()
    {
        ...
        $this->assertStringEqualsFile( self::$fixturesPath.'/php/services26.php', $dumper->dump( [
            'class' => 'Symfony_DI_PhpDumper_Test_EnvParameters',
            'file' => self::$fixturesPath.'/php/services26.php'
        ] ) );
    ...
    public function testDumpedBase64EnvParameters()
    {
        ...
        $this->assertStringEqualsFile( self::$fixturesPath.'/php/services_base64_env.php',
            $dumper->dump( ['class' => 'Symfony_DI_PhpDumper_Test_Base64Parameters'] ) );
    ...
    public function testDumpedCsvEnvParameters()
    {
        ...
        $this->assertStringEqualsFile( self::$fixturesPath.'/php/services_csv_env.php',
            $dumper->dump( ['class' => 'Symfony_DI_PhpDumper_Test_CsvParameters'] ) );
    ...
    public function testDumpedJsonEnvParameters()
    {
        ...
        $this->assertStringEqualsFile( self::$fixturesPath.'/php/services_json_env.php',
            $dumper->dump( ['class' => 'Symfony_DI_PhpDumper_Test_JsonParameters'] ) );
    ...
    public function testCustomEnvParameters()
    {
        ...
        $this->assertStringEqualsFile( self::$fixturesPath.'/php/services_rot13_env.php',
            $dumper->dump( ['class' => 'Symfony_DI_PhpDumper_Test_Rot13Parameters'] ) );
     ...
     * @expectedExceptionMessage Environment variables "FOO" are never used. Please, check your container's
     *     configuration.
     */
    ...
    {
        $container = new ContainerBuilder();
        $container->register( 'foo', 'stdClass' )->addMethodCall( 'add',
            [new Reference( 'service_container' )] )->setPublic( false );
        $container->register( 'bar', 'stdClass' )->addArgument( new Reference( 'foo' ) )->setPublic( true );
        $container->compile();

        $dumper = new PhpDumper( $container );
        $this->assertStringEqualsFile( self::$fixturesPath.'/php/services13.php', $dumper->dump(),
            '->dump() dumps inline definitions which reference service_container' );
    }
    ...
    public function testNonSharedLazyDefinitionReferences()
    {
        ...
        $container->register( 'bar', 'stdClass' )->addArgument( new Reference( 'foo',
            ContainerBuilder::EXCEPTION_ON_INVALID_REFERENCE, false ) )->setPublic( true );
        $container->compile();
    ...
    public function testCircularReferenceAllowanceForLazyServices()
    {
        ...
        $container->register( 'bar',
            'stdClass' )->setLazy( true )->addArgument( new Reference( 'foo' ) )->setPublic( true );
        $container->compile();
        ...
        $container
            ...
            ->setArguments( [
                new IteratorArgument( [
                    'k1' => new Reference( 'lazy_referenced' ),
    ...
    public function testPrivateWithIgnoreOnInvalidReference()
    {
        ...
        $container->register( 'bar', 'BarClass' )
            ->setPublic( true )
            ->addMethodCall( 'setBaz',
                [new Reference( 'not_invalid', SymfonyContainerInterface::IGNORE_ON_INVALID_REFERENCE )] );
        $container->compile();
    ...
    public function testArrayParameters()
    {
        ...
        $this->assertStringEqualsFile( self::$fixturesPath.'/php/services_array_params.php',
            str_replace( '\\\\Dumper', '/Dumper',
                $dumper->dump( ['file' => self::$fixturesPath.'/php/services_array_params.php'] ) ) );
    }
    ...
    public function testUninitializedReference()
    {
        ...
        $this->assertStringEqualsFile( self::$fixturesPath.'/php/services_uninitialized_ref.php',
            $dumper->dump( ['class' => 'Symfony_DI_PhpDumper_Test_Uninitialized_Reference'] ) );
    ...
    public function testAlmostCircular( $visibility )
    {
        ...
        $this->assertStringEqualsFile( self::$fixturesPath.'/php/services_almost_circular_'.$visibility.'.php',
            $dumper->dump( ['class' => $container] ) );
    ...
    public function testDeepServiceGraph()
    {
        ...
        $this->assertStringEqualsFile( self::$fixturesPath.'/php/services_deep_graph.php',
            $dumper->dump( ['class' => 'Symfony_DI_PhpDumper_Test_Deep_Graph'] ) );
    ...
    public function testInlineSelfRef()
    {
        ...
        $dumper = new PhpDumper( $container );
        $this->assertStringEqualsFile( self::$fixturesPath.'/php/services_inline_self_ref.php',
            $dumper->dump( ['class' => 'Symfony_DI_PhpDumper_Test_Inline_Self_Ref'] ) );
    }
    ...
    public function testHotPathOptimizations()
    {
        ...
        $dump = $dumper->dump( [
            ...
            'file' => self::$fixturesPath.'/php/services_inline_requires.php'
        ] );
        if ( '\\' === \DIRECTORY_SEPARATOR )
        {
    ...
    public function testErroredDefinition()
    {
        ...
        $this->assertStringEqualsFile( self::$fixturesPath.'/php/services_errored_definition.php',
            str_replace( str_replace( '\\', '\\\\',
                self::$fixturesPath.\DIRECTORY_SEPARATOR.'includes'.\DIRECTORY_SEPARATOR ), '%path%', $dump ) );
        eval( '?>'.$dump );
