...
class XmlDumperTest extends TestCase
{
    ...
    public function testDump()
    {
        ...
        $this->assertXmlStringEqualsXmlFile( self::$fixturesPath.'/xml/services1.xml', $dumper->dump(),
            '->dump() dumps an empty container as an empty XML file' );
    }
    ...
    public function testExportParameters()
    {
        ...
        $this->assertXmlStringEqualsXmlFile( self::$fixturesPath.'/xml/services8.xml', $dumper->dump(),
    ...
    public function testAddService()
    {
        ...
        $this->assertEquals( str_replace( '%path%',
            self::$fixturesPath.\DIRECTORY_SEPARATOR.'includes'.\DIRECTORY_SEPARATOR,
            file_get_contents( self::$fixturesPath.'/xml/services9.xml' ) ), $dumper->dump(),
            '->dump() dumps services' );
