...
class YamlFileLoaderTest extends TestCase
{
    ...
    public function testLoadParameters()
    {
        ...
        $this->assertEquals( [
            ...
            'values' => [true, false, 0, 1000.3, PHP_INT_MAX],
            'bar' => 'foo',
            'escape' => '@escapeme',
            'foo_bar' => new Reference( 'foo_bar' )
        ], $container->getParameterBag()->all(), '->load() converts YAML keys to lowercase' );
    }
    ...
    public function testLoadServices()
    {
        ...
        $this->assertEquals( ['foo', new Reference( 'baz' )], $services[ 'Acme\WithShortCutArgs' ]->getArguments(),
            '->load() parses short service definition' );
    ...
    public function testLoadFactoryShortSyntax()
    {
        ...
        $this->assertEquals( [new Reference( 'baz' ), 'getClass'], $services[ 'factory' ]->getFactory(),
            '->load() parses the factory tag with service:method' );
        $this->assertEquals( ['FooBacFactory', 'createFooBar'], $services[ 'factory_with_static_call' ]->getFactory(),
            '->load() parses the factory tag with Class::method' );
    }
    ...
    public function testLoadConfiguratorShortSyntax()
    {
        ...
        $this->assertEquals( [new Reference( 'foo_bar_configurator' ), 'configure'],
            $services[ 'foo_bar' ]->getConfigurator(), '->load() parses the configurator tag with service:method' );
        $this->assertEquals( ['FooBarConfigurator', 'configureFooBar'],
            $services[ 'foo_bar_with_static_call' ]->getConfigurator(),
            '->load() parses the configurator tag with Class::method' );
    }
    ...
    public function testExtensions()
    {
        ...
        catch ( \Exception $e )
        {
            ...
            $this->assertStringStartsWith( 'There is no extension able to load the configuration for "foobarfoobar" (in',
    ...
    public function testTagWithoutNameThrowsException()
    {
        ...
        catch ( \Exception $e )
        {
            ...
            $this->assertStringStartsWith( 'A "tags" entry is missing a "name" key for service ', $e->getMessage(),
                '->load() throws an InvalidArgumentException if a tag is missing the name key' );
        }
    }
    ...
    public function testTagWithAttributeArrayThrowsException()
    {
        ...
        catch ( \Exception $e )
        {
            ...
            $this->assertStringStartsWith( 'A "tags" attribute must be of a scalar-type for service "foo_service", tag "foo", attribute "bar"',
                $e->getMessage(), '->load() throws an InvalidArgumentException if a tag-attribute is not a scalar' );
        }
    }
    ...
    public function testLoadYamlOnlyWithKeys()
    {
        ...
        $this->assertEquals( [['setLogger', [new Reference( 'logger' )]], ['setClass', ['User']]],
    ...
    public function testPrototype()
    {
        ...
        $this->assertContains( (string)( new FileResource( $fixturesDir.'yaml'.\DIRECTORY_SEPARATOR.'services_prototype.yml' ) ),
            $resources );
    ...
    /**
     * @expectedException \Symfony\Component\DependencyInjection\Exception\InvalidArgumentException
     * @expectedExceptionMessageRegExp /A "resource" attribute must be set when the "namespace" attribute is set for
     *     service ".+" in .+/
     */
    ...
    public function testNamedArguments()
    {
        ...
        $this->assertEquals( [null, '$apiKey' => 'ABCD'],
        ...
        $this->assertEquals( ['$apiKey' => 'ABCD', CaseSensitiveClass::class => null],
            $container->getDefinition( 'another_one' )->getArguments() );
     ...
     *     "_instanceof" configuration is defined as using both is not supported. Move your child definitions to a
     *     separate file.
     */
    ...
    /**
     * @expectedException \Symfony\Component\DependencyInjection\Exception\InvalidArgumentException
     * @expectedExceptionMessage Attribute "autowire" on service "child_service" cannot be inherited from "_defaults"
    ...
    /**
     * @expectedException \Symfony\Component\DependencyInjection\Exception\InvalidArgumentException
     * @expectedExceptionMessage The value of the "decorates" option for the "bar" service must be the id of the
     *     service without the "@" prefix (replace "@foo" with "foo").
     */
    ...
    /**
     * @expectedException \Symfony\Component\DependencyInjection\Exception\InvalidArgumentException
     * @expectedExceptionMessageRegExp /Parameter "tags" must be an array for service "Foo\\Bar" in
     *     .+services31_invalid_tags\.yml\. Check your YAML syntax./
     */
    ...
    /**
     * @expectedException \Symfony\Component\DependencyInjection\Exception\InvalidArgumentException
     * @expectedExceptionMessage Service names that start with an underscore are reserved. Rename the "_foo" service or
     *     define it in XML instead.
     */
    ...
    /**
     * @expectedException \Symfony\Component\DependencyInjection\Exception\InvalidArgumentException
     * @expectedExceptionMessageRegExp /Creating an alias using the tag "!service" is not allowed in
    ...
    /**
     * @expectedException \Symfony\Component\DependencyInjection\Exception\InvalidArgumentException
     * @expectedExceptionMessageRegExp /Using an anonymous service in a parameter is not allowed in
    ...
    /**
     * @expectedException \Symfony\Component\DependencyInjection\Exception\InvalidArgumentException
     * @expectedExceptionMessageRegExp /Service "_defaults" key must be an array, "NULL" given in
    ...
    /**
     * @expectedException \Symfony\Component\DependencyInjection\Exception\InvalidArgumentException
     * @expectedExceptionMessageRegExp /Service "_instanceof" key must be an array, "NULL" given in
    ...
    /**
     * @expectedException \Symfony\Component\DependencyInjection\Exception\InvalidArgumentException
     * @expectedExceptionMessageRegExp /^The configuration key "calls" is unsupported for the service "bar" which is
     *     defined as an alias/
     */
