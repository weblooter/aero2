...
class PhpFileLoaderTest extends TestCase
{
    public function testSupports()
    {
        ...
        $this->assertTrue( $loader->supports( 'with_wrong_ext.yml', 'php' ),
    ...
    public function testConfigServices()
    {
        ...
        $this->assertStringEqualsFile( $fixtures.'/php/services9_compiled.php',
            str_replace( str_replace( '\\', '\\\\', $fixtures.\DIRECTORY_SEPARATOR.'includes'.\DIRECTORY_SEPARATOR ),
                '%path%', $dumper->dump() ) );
    }
     ...
     *     disabling autoconfiguration for the service.
     */
    ...
    /**
     * @expectedException \Symfony\Component\DependencyInjection\Exception\InvalidArgumentException
     * @expectedExceptionMessage Invalid factory "factory:method": the `service:method` notation is not available when
     *     using PHP-based DI configuration. Use "[ref('factory'), 'method']" instead.
     */
