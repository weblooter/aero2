...
abstract class AbstractDumper implements DataDumperInterface, DumperInterface
{
     ...
     * @param callable|resource|string|true|null $output A line dumper callable, an opened stream, an output path or
     *     true to return the dump
     *
    ...
    public function dump( Data $data, $output = null )
    {
        ...
        if ( $locale = $this->flags & ( self::DUMP_COMMA_SEPARATOR | self::DUMP_TRAILING_COMMA ) ? setlocale( LC_NUMERIC,
            0 ) : null )
        {
