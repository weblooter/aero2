...
class ClassStub extends ConstStub
{
     ...
     * @param callable $callable The callable targeted by the identifier when it is ambiguous or not a real PHP
     *     identifier
     */
    public function __construct( string $identifier, $callable = null )
    {
        ...
        try
        {
            ...
            {
                $this->value = $identifier = preg_replace_callback( '/class@anonymous\x00.*?\.php0x?[0-9a-fA-F]++/',
                    function ( $m ) {
