...
class UploadedFile extends File
{
     ...
     * @param int|null    $error The error constant of the upload (one of PHP's UPLOAD_ERR_XXX constants); null
    ...
    public function __construct( string $path, string $originalName, string $mimeType = null, int $error = null, $test = false )
    {
        ...
        {
            @trigger_error( sprintf( 'Passing a size as 4th argument to the constructor of "%s" is deprecated since Symfony 4.1.',
    ...
    {
        @trigger_error( sprintf( 'The "%s()" method is deprecated since Symfony 4.1. Use getSize() instead.',
