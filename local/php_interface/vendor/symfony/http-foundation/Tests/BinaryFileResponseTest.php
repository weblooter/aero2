...
class BinaryFileResponseTest extends ResponseTestCase
{
    ...
    public function testSetContentDispositionGeneratesSafeFallbackFilename()
    {
        ...
        $this->assertSame( 'attachment; filename=f__.html; filename*=utf-8\'\'f%C3%B6%C3%B6.html',
    ...
    public function testSetContentDispositionGeneratesSafeFallbackFilenameForWronglyEncodedFilename()
    {
        ...
        $this->assertSame( 'attachment; filename=f__.html; filename*=utf-8\'\'f%F6%F6.html',
            $response->headers->get( 'Content-Disposition' ) );
    }
    ...
    public function testRequests( $requestRange, $offset, $length, $responseRange )
    {
        $response = BinaryFileResponse::create( __DIR__.'/File/Fixtures/test.gif', 200,
            ['Content-Type' => 'application/octet-stream'] )->setAutoEtag();
    ...
    public function testRangeRequestsWithoutLastModifiedDate()
    {
        ...
        $response = BinaryFileResponse::create( __DIR__.'/File/Fixtures/test.gif', 200,
            ['Content-Type' => 'application/octet-stream'], true, null, false, false );
    ...
    {
        $request = Request::create( '/' );
        $response = new BinaryFileResponse( new Stream( __DIR__.'/../README.md' ), 200,
