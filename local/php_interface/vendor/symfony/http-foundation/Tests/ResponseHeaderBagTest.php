...
class ResponseHeaderBagTest extends TestCase
{
    public function testAllPreserveCase()
    {
        ...
        {
            $this->assertArrayHasKey( $headerName, $allPreservedCase,
    ...
    public function testToStringIncludesCookieHeaders()
    {
        ...
        $this->assertSetCookieHeader( 'foo=deleted; expires='.gmdate( 'D, d-M-Y H:i:s T',
                time() - 31536001 ).'; Max-Age=0; path=/; httponly', $bag );
    }
    ...
    public function testClearCookieSecureNotHttpOnly()
    {
        ...
        $this->assertSetCookieHeader( 'foo=deleted; expires='.gmdate( 'D, d-M-Y H:i:s T',
                time() - 31536001 ).'; Max-Age=0; path=/; secure', $bag );
    }
    ...
    public function testCookiesWithSameNames()
    {
        ...
        $this->assertEquals( 'foo=bar; path=/path/foo; domain=foo.bar; httponly; samesite=lax',
            $bag->get( 'set-cookie' ) );
        $this->assertEquals( [
    ...
    public function testSetCookieHeader()
    {
        ...
        $this->assertEquals( [Cookie::create( 'foo', 'bar', 0, '/', null, false, false, true, null )],
            $bag->getCookies() );
    ...
    {
        $this->assertRegExp( '#^Set-Cookie:\s+'.preg_quote( $expected, '#' ).'$#m',
            str_replace( "\r\n", "\n", (string)$actual ) );
    }
}
