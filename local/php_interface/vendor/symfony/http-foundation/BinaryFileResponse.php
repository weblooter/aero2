...
class BinaryFileResponse extends Response
{
     ...
     * @param string|null         $contentDisposition The type of Content-Disposition to set automatically with the
     *     filename
     ...
     * @param string $filenameFallback A fallback filename, containing only ASCII characters. Defaults to an
     *     automatically encoded filename
     *
     * @return $this
     */
