...
class YamlFileLoaderTest extends TestCase
{
    public function testSupports()
    {
        ...
        $this->assertTrue( $loader->supports( 'foo.yml', 'yaml' ),
            '->supports() checks the resource type if specified' );
        $this->assertTrue( $loader->supports( 'foo.yaml', 'yaml' ),
            '->supports() checks the resource type if specified' );
        $this->assertFalse( $loader->supports( 'foo.yml', 'foo' ),
            '->supports() checks the resource type if specified' );
    }
    ...
    /**
     * @expectedException \InvalidArgumentException
     * @expectedExceptionMessageRegExp /The routing file "[^"]*" must not specify both the "controller" key and the
     *     defaults key "_controller" for "app_blog"/
     */
     ...
     * @expectedException \InvalidArgumentException
     * @expectedExceptionMessageRegExp /The routing file "[^"]*" must not specify both the "controller" key and the
     *     defaults key "_controller" for "_static"/
     */
    ...
    public function testImportingWithControllerDefault()
    {
        ...
        $this->assertCount( 3, $routes );
        $this->assertEquals( 'DefaultController::defaultAction',
