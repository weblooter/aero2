...
class UrlMatcherTest extends TestCase
{
    ...
    public function testMatchNonAlpha()
    {
        ...
        $collection->add( 'foo',
            new Route( '/{foo}/bar', [], ['foo' => '['.preg_quote( $chars ).']+'], ['utf8' => true] ) );

        $matcher = $this->getUrlMatcher( $collection );
        $this->assertEquals( ['_route' => 'foo', 'foo' => $chars],
    ...
    public function testMatchOverriddenRoute()
    {
        ...
        $this->{method_exists( $this,
            $_ = 'expectException' ) ? $_ : 'setExpectedException'}( 'Symfony\Component\Routing\Exception\ResourceNotFoundException' );
    ...
    public function testDefaultRequirementForOptionalVariables()
    {
        ...
        $matcher = $this->getUrlMatcher( $coll );
        $this->assertEquals( ['page' => 'my-page', '_format' => 'xml', '_route' => 'test'],
    ...
    public function testMatchingIsEager()
    {
        ...
        $matcher = $this->getUrlMatcher( $coll );
        $this->assertEquals( ['foo' => 'text1-text2-text3', 'bar' => 'text4', '_route' => 'test'],
    ...
    public function testAdjacentVariables()
    {
        $coll = new RouteCollection();
        $coll->add( 'test',
            new Route( '/{w}{x}{y}{z}.{_format}', ['z' => 'default-z', '_format' => 'html'], ['y' => 'y|Y'] ) );
    ...
    public function testDefaultRequirementOfVariable()
    {
        ...
        $this->assertEquals( ['page' => 'index', '_format' => 'mobile.html', '_route' => 'test'],
    ...
    public function testUtf8AndMethodMatching()
    {
        $coll = new RouteCollection();
        $coll->add( 'a',
            new Route( '/admin/api/list/{shortClassName}/{id}.{_format}', [], [], ['utf8' => true], '', [], ['PUT'] ) );
