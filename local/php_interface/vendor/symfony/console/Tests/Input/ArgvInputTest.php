...
class ArgvInputTest extends TestCase
{
    public function testConstructor()
    {
        ...
        $this->assertEquals( ['foo'], $p->getValue( $input ),
    ...
    public function testParseArrayArgument()
    {
        ...
        $this->assertEquals( ['name' => ['foo', 'bar', 'baz', 'bat']], $input->getArguments(),
    ...
    public function testParseArrayOption()
    {
        ...
        $this->assertEquals( ['name' => ['foo', 'bar', 'baz']], $input->getOptions(),
        ...
        $this->assertSame( ['name' => ['foo', 'bar', '']], $input->getOptions(),
        ...
        $this->assertSame( ['name' => ['foo', 'bar', null], 'anotherOption' => true], $input->getOptions(),
    ...
    public function testParseNegativeNumberAfterDoubleDash()
    {
        ...
        $this->assertEquals( ['number' => '-1'], $input->getArguments(),
        ...
        $this->assertEquals( ['foo' => 'bar'], $input->getOptions(),
    ...
    public function testHasParameterOption()
    {
        ...
        $this->assertTrue( $input->hasParameterOption( '-e' ),
            '->hasParameterOption() returns true if the given short option is in the raw input' );
        $this->assertFalse( $input->hasParameterOption( '-s' ),
            '->hasParameterOption() returns true if the given short option is in the raw input' );
    ...
    {
        $input = new ArgvInput( ['cli.php', '-f', 'foo'] );
        $this->assertTrue( $input->hasParameterOption( '-f', true ),
            '->hasParameterOption() returns true if the given short option is in the raw input' );

        $input = new ArgvInput( ['cli.php', '--foo', '--', 'foo'] );
        $this->assertTrue( $input->hasParameterOption( '--foo', true ),
    ...
    public function testHasParameterOptionEdgeCasesAndLimitations()
    {
        ...
        $this->assertFalse( $input->hasParameterOption( '-h' ),
            '->hasParameterOption() returns true if the given short option is in the raw input' );
        ...
        // instead.
        $this->assertTrue( $input->hasParameterOption( '-fh' ),
            '->hasParameterOption() returns true if the given short option is in the raw input' );
        // In theory, if -fh is supported, then -hf should also work.
        // However, this is not supported.
        $this->assertFalse( $input->hasParameterOption( '-hf' ),
            '->hasParameterOption() returns true if the given short option is in the raw input' );
        ...
        $this->assertFalse( $input->hasParameterOption( '-fh' ),
            '->hasParameterOption() returns true if the given short option is in the raw input' );
    }
    ...
    {
        $input = new ArgvInput( $argv );
        $this->assertEquals( $expected, $input->getParameterOption( $key, $default, $onlyParams ),
    ...
    public function testParseOptionWithValueOptionalGivenEmptyAndRequiredArgument()
    {
        ...
        $this->assertEquals( ['foo' => null], $input->getOptions(),
        ...
        $this->assertEquals( ['foo' => '0'], $input->getOptions(),
            '->parse() parses optional options with empty value as null' );
        $this->assertEquals( ['name' => 'bar'], $input->getArguments(), '->parse() parses required arguments' );
    }
