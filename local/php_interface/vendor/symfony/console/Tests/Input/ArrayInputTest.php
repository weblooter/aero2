...
class ArrayInputTest extends TestCase
{
    ...
    public function testHasParameterOption()
    {
        ...
        $this->assertTrue( $input->hasParameterOption( '--bar' ),
            '->hasParameterOption() returns true if an option is present in the passed parameters' );
        $this->assertFalse( $input->hasParameterOption( '--bar', true ),
    ...
    public function testGetParameterOption()
    {
        ...
        $this->assertEquals( 'default', $input->getParameterOption( '--bar', 'default' ),
        ...
        $this->assertEquals( 'woop', $input->getParameterOption( '--bar' ),
            '->getParameterOption() returns the correct value if an option is present in the passed parameters' );
        $this->assertEquals( 'default', $input->getParameterOption( '--bar', 'default', true ),
