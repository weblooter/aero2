...
class HelperSetTest extends TestCase
{
    ...
    public function testSet()
    {
        ...
        $this->assertTrue( $helperset->has( 'fake_helper_01' ),
            '->set() will set multiple helpers on consecutive calls' );
        $this->assertTrue( $helperset->has( 'fake_helper_02' ),
            '->set() will set multiple helpers on consecutive calls' );
    ...
    public function testGet()
    {
        ...
        $this->assertEquals( $helper_02, $helperset->get( 'fake_helper_02' ),
            '->get() returns correct helper by name' );
        ...
        catch ( \Exception $e )
        {
            ...
            $this->assertInstanceOf( 'Symfony\Component\Console\Exception\ExceptionInterface', $e,
