...
class AddConsoleCommandPassTest extends TestCase
{
    ...
    public function testProcessRegistersLazyCommands()
    {
        ...
        $this->assertSame( ['my:command' => 'my-command', 'my:alias' => 'my-command'],
    ...
    public function testProcessFallsBackToDefaultName()
    {
        ...
        $this->assertEquals( [
            [
                'with-default-name' => new ServiceClosureArgument( new TypedReference( 'with-default-name',
                    NamedCommand::class ) )
            ]
        ], $commandLocator->getArguments() );
        $this->assertSame( [], $container->getParameter( 'console.command.ids' ) );
        ...
        $this->assertSame( ['new-name' => 'with-default-name'],
    ...
    /**
     * @expectedException \InvalidArgumentException
     * @expectedExceptionMessage The service "my-command" tagged "console.command" must be a subclass of
