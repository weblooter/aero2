...
class Table
{
    ...
    public function appendRow( $row ): self
    {
        ...
        {
            throw new RuntimeException( sprintf( 'Output should be an instance of "%s" when calling "%s".',
                ConsoleSectionOutput::class, __METHOD__ ) );
        }
    ...
    public function render()
    {
        ...
        foreach ( $rows as $row )
        {
            ...
            $this->renderRow( $row,
                $isHeader ? $this->style->getCellHeaderFormat() : $this->style->getCellRowFormat() );
        }
    ...
    private function renderColumnSeparator( $type = self::BORDER_OUTSIDE )
    {
        ...
        return sprintf( $this->style->getBorderFormat(),
    ...
    private function fillNextRows( array $rows, int $line ): array
    {
        ...
        {
            if ( null !== $cell && !$cell instanceof TableCell && !is_scalar( $cell ) && !( \is_object( $cell ) && method_exists( $cell,
                        '__toString' ) ) )
            {
