...
class TextDescriptor extends Descriptor
{
    ...
    protected function describeApplication( Application $application, array $options = [] )
    {
        ...
        else
        {
            ...
            $width = $this->getColumnWidth( array_merge( ...
                array_values( array_map( function ( $namespace ) use ( $commands ) {
            ...
            {
                $namespace[ 'commands' ] = array_filter( $namespace[ 'commands' ],
                ...
                foreach ( $namespace[ 'commands' ] as $name )
                {
                    ...
                    $this->writeText( sprintf( '  <info>%s</info>%s%s', $name, str_repeat( ' ', $spacingWidth ),
                        $commandAliases.$command->getDescription() ), $options );
                }
            }
    ...
    private function calculateTotalWidthForOptions( array $options ): int
    {
        ...
        {
            // "-" + shortcut + ", --" + name
            $nameLength = 1 + max( Helper::strlen( $option->getShortcut() ),
                    1 ) + 4 + Helper::strlen( $option->getName() );
