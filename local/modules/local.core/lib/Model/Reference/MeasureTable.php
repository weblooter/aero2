...
/**
 * Справочник с единицами измерения для апи фида<br/>
 *
 * <ul><li>ID - ID | Fields\IntegerField</li><li>DATE_CREATE - Дата создания [14.03.2019 20:21:00] | Fields\DatetimeField</li><li>DATE_MODIFIED - Дата последнего изменения [14.03.2019 20:21:00] | Fields\DatetimeField</li><li>GROUP - Группа | Fields\EnumField<br/>&emsp;ECONOM => Экономические единицы<br/>&emsp;TIME => Единицы времени<br/>&emsp;LENGTH => Единицы длины<br/>&emsp;WEIGHT => Единицы массы<br/>&emsp;VOLUME => Единицы объема<br/>&emsp;AREA => Единицы площади<br/></li><li>NAME - Название | Fields\StringField</li><li>CODE - Символьный код | Fields\StringField</li><li>SORT - Сортировка [500] | Fields\IntegerField</li></ul>
 *
