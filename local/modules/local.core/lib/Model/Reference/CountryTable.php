 ...
 * Fields\DatetimeField</li><li>SORT - Сортировка [50] | Fields\IntegerField</li><li>NAME - Название | Fields\StringField</li><li>CODE - Символьный код | Fields\StringField</li></ul>
 *
 * @package Local\Core\Model\Data
 */
class CountryTable extends \Local\Core\Inner\BxModified\Main\ORM\Data\DataManager
{
    use \Local\Core\Inner\Traits\Reference\ClearReferenceCache;

    public static function getTableName()
    {
        return 'a_model_reference_country';
    }
