...
class StoreProductTable extends \Local\Core\Inner\BxModified\Main\ORM\Data\DataManager
{
    ...
    public static function getMap()
    {
        return [
            ...
            new Fields\IntegerField('PRODUCT_GROUP_ID', [
                    'title' => 'ID группы товара',
                    'required' => false,
                ]),
            new Fields\StringField('ARTICLE', [
            ...
            new Fields\StringField('SIMPLE_NAME', [
                    'title' => 'Простое название товара',
                    'required' => true,
                ]),
            new Fields\StringField('MANUFACTURER', [
                    'title' => 'Название компании производителя',
                    'required' => true,
                ]),
            new Fields\StringField('MODEL', [
                    'title' => 'Модель товара',
                    'required' => false,
                ]),
            ...
            new Fields\StringField('MANUFACTURER_CODE', [
            ...
            new Fields\FloatField('OLD_PRICE', [
            ...
            new Fields\TextField('IMAGE', [
                    'title' => 'Изображения',
                    'required' => false,
                ]),
            new Fields\EnumField('COUNTRY_OF_PRODUCTION_CODE', [
            ...
            new Fields\EnumField('IS_SOFTWARE', [
