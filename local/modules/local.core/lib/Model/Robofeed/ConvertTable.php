    ...
    public static function getMap()
    {
        return [
            ...
            new Fields\StringField(
                'ORIGINAL_FILE_NAME', ['title' => 'Название файла']
            ),
            new Fields\IntegerField(
                'EXPORT_FILE_ID', [
        ...
        if( $intNowInQueue >= $intMaxInQueue )
        {
            $result->addError(
                new \Bitrix\Main\ORM\EntityError(
                    'Максимально доступное кол-во файлов в очереди на конвертацию - '.$intMaxInQueue.'. Дождитесь окончания конвертации и повторите попытку.'
                )
            );
