...
class Schema extends \Local\Core\Inner\Robofeed\Schema\AbstractSchema
{
    ...
    protected static function getSchemaBody()
    {
        return [
            ...
            'offers' => [
                'offer' => [
                    '@attr' => [
                        'id' => new SchemaFields\IntegerField('robofeed__offers__offer__@id', [
                            'required' => true,
                            'title' => 'Идентификатор товара, уникален',
                            'xml_path' => 'robofeed->offers->offer->@id',
                            'site' => 9
                        ]),
                        'groupId' => new SchemaFields\IntegerField('robofeed__offers__offer__@groupId', [
                            'required' => false,
    ...
    private static function getSchemaCategories()
    {
        return [
            'category' => [
                '@attr' => [
                    'id' => new SchemaFields\IntegerField('robofeed__categories__category__@id', [
                        'required' => true,
                        'title' => 'Идентификатор категории, уникален',
                        'xml_path' => 'robofeed->categories->category->@id',
                        'site' => 9
                    ]),
                    'parentId' => new SchemaFields\IntegerField('robofeed__categories__category__@parentId', [
                        'required' => false,
                ...
                '@value' => new SchemaFields\StringField('robofeed__categories__category__@value', [
                        'required' => true,
    ...
    {
        return [
            'article' => new SchemaFields\StringField($name.'__article', [
                'required' => true,
                'title' => 'Артикул товара',
                'xml_path' => $path.'->article',
                'site' => 30
            ]),
            'fullName' => new SchemaFields\StringField($name.'__fullName', [
                'required' => true,
                'title' => 'Полное название товара',
                'xml_path' => $path.'->fullName'
            ]),
            'simpleName' => new SchemaFields\StringField($name.'__simpleName', [
                'required' => true,
                'title' => 'Простое название товара',
                'xml_path' => $path.'->simpleName',
                'site' => 30
            ]),
            'manufacturer' => new SchemaFields\StringField($name.'__manufacturer', [
                'required' => true,
                'title' => 'Название компании производителя',
                'xml_path' => $path.'->manufacturer',
            ]),
            'model' => new SchemaFields\StringField($name.'__model', [
                'required' => false,
                'title' => 'Модель товара',
                'xml_path' => $path.'->model',
            ]),
            'url' => new SchemaFields\StringField($name.'__url', [
                'required' => false,
                'title' => 'Ссылка на детальную страницу товара',
                'xml_path' => $path.'->url',
                'format' => '/^https?\:\/\//'
            ]),
            'manufacturerCode' => new SchemaFields\StringField($name.'__manufacturerCode', [
                'required' => false,
                'title' => 'Код производителя для данного товара',
                'xml_path' => $path.'->manufacturerCode',
                'size' => 50
            ]),
            'price' => new SchemaFields\NumericField($name.'__price', [
                'required' => true,
                'title' => 'Текущая публичная стоимость товара',
                'xml_path' => $path.'->price',
                'scale' => 2
            ]),
            'oldPrice' => new SchemaFields\NumericField($name.'__oldPrice', [
                'required' => false,
                'title' => 'Базовая / старая стоимость товара',
                'xml_path' => $path.'->oldPrice',
                'scale' => 2
            ]),
            'currencyCode' => new SchemaFields\ReferenceField($name.'__currencyCode', [
                'required' => true,
                'title' => 'Символьный код валюты',
                'xml_path' => $path.'->currencyCode',
                'class' => CurrencyTable::class
            ]),
            'quantity' => new SchemaFields\IntegerField($name.'__quantity', [
                'required' => true,
                'title' => 'Количество товара в единицах измерения',
                'xml_path' => $path.'->quantity',
                'size' => 9
            ]),
            'unitOfMeasure' => new SchemaFields\ReferenceField($name.'__unitOfMeasure', [
                'required' => true,
                'title' => 'Символьный код единицы измерения',
                'xml_path' => $path.'->unitOfMeasure',
                'class' => MeasureTable::class
            ]),
            'minQuantity' => new SchemaFields\IntegerField($name.'__minQuantity', [
                'required' => true,
                'title' => 'Минимальное кол-во товара в заказе',
                'xml_path' => $path.'->minQuantity',
                'size' => 9
            ]),
            'categoryId' => new SchemaFields\IntegerField($name.'__categoryId', [
                'required' => true,
                'title' => 'ID категории товара',
                'xml_path' => $path.'->categoryId',
                'size' => 9
            ]),
            'image' => new SchemaFields\StringField($name.'__image', [
                'required' => false,
                'title' => 'Ссылка на изображение',
                'xml_path' => $path.'->image',
                'format' => '/^https?\:\/\//'
            ]),
            'countryOfProductionCode' => new SchemaFields\ReferenceField($name.'__countryOfProductionCode', [
                'required' => false,
                'title' => 'Символьный код страны производства',
                'xml_path' => $path.'->countryOfProductionCode',
                'class' => CountryTable::class
            ]),
            'description' => new SchemaFields\TextField($name.'__description', [
                'required' => false,
            ...
            'inStock' => new SchemaFields\BooleanField($name.'__inStock', [
                'required' => true,
                'title' => 'Товар есть в наличии',
                'xml_path' => $path.'->inStock',
            ]),
            'salesNotes' => new SchemaFields\StringField($name.'__salesNotes', [
                'required' => false,
            ...
            'param' => [
                '@attr' => [
                    'code' => new SchemaFields\StringField($name.'__param__@code', [
                        'required' => true,
                    ...
                    'name' => new SchemaFields\StringField($name.'__param__@name', [
                        'required' => true,
                ...
                '@value' => new SchemaFields\StringField($name.'__param', [
                    'required' => true,
    ...
    private static function getSchemaDelivery($name, $path)
    {
        return [
            '@attr' => [
                'available' => new SchemaFields\BooleanField($name.'__delivery__@available', [
                    'required' => true,
            ...
            'option' => [
                '@attr' => [
                    'priceFrom' => new SchemaFields\IntegerField($name.'__delivery__option__@priceFrom', [
                        'required' => true,
                        'title' => 'Стоимость доставки "от"',
                        'xml_path' => $path.'->delivery->option->@priceFrom',
                        'size' => 9
                    ]),
                    'priceTo' => new SchemaFields\IntegerField($name.'__delivery__option__@priceTo', [
                        'required' => false,
                        'title' => 'Стоимость доставки "до"',
                        'xml_path' => $path.'->delivery->option->@priceTo',
                        'size' => 9
                    ]),
                    'currencyCode' => new SchemaFields\ReferenceField($name.'__delivery__option__@currencyCode', [
                        'required' => true,
                        'title' => 'Символьный код валюты стоимости',
                        'xml_path' => $path.'->delivery->option->@currencyCode',
                        'class' => CurrencyTable::class
                    ]),
                    'daysFrom' => new SchemaFields\IntegerField($name.'__delivery__option__@daysFrom', [
                        'required' => true,
                        'title' => 'Сроки доставки "от" в днях',
                        'xml_path' => $path.'->delivery->option->@daysFrom',
                        'size' => 2,
                    ]),
                    'daysTo' => new SchemaFields\IntegerField($name.'__delivery__option__@daysTo', [
                        'required' => false,
                        'title' => 'Сроки доставки "до" в днях',
                        'xml_path' => $path.'->delivery->option->@daysTo',
                        'size' => 2,
                    ]),
                    'orderBefore' => new SchemaFields\IntegerField($name.'__delivery__option__@orderBefore', [
                        'required' => false,
                    ...
                    'orderAfter' => new SchemaFields\IntegerField($name.'__delivery__option__@orderAfter', [
                        'required' => false,
                    ...
                    'deliveryRegion' => new SchemaFields\EnumField($name.'__delivery__option__@deliveryRegion', [
                        'required' => true,
    ...
    private static function getSchemaPickup($name, $path)
    {
        return [
            '@attr' => [
                'available' => new SchemaFields\BooleanField($name.'__pickup__@available', [
                    'required' => true,
            ...
            'option' => [
                '@attr' => [
                    'price' => new SchemaFields\StringField($name.'__pickup__option__@price', [
                        'required' => true,
                        'title' => 'Стоимость самовывоза',
                        'xml_path' => $path.'->pickup->option->@price',
                    ]),
                    'currencyCode' => new SchemaFields\ReferenceField($name.'__pickup__option__@currencyCode', [
                        'required' => true,
                        'title' => 'Символьный код валюты стоимости',
                        'xml_path' => $path.'->pickup->option->@currencyCode',
                        'class' => CurrencyTable::class
                    ]),
                    'supplyFrom' => new SchemaFields\IntegerField($name.'__pickup__option__@supplyFrom', [
                        'required' => true,
                        'title' => 'Сроки поступления товара в магазин/на склад "от" в днях',
                        'xml_path' => $path.'->pickup->option->@supplyFrom',
                        'size' => 2
                    ]),
                    'supplyTo' => new SchemaFields\IntegerField($name.'__pickup__option__@supplyTo', [
                        'required' => true,
                        'title' => 'Сроки поступления товара в магазин/на склад "до" в днях',
                        'xml_path' => $path.'->pickup->option->@supplyTo',
                        'size' => 2
                    ]),
                    'orderBefore' => new SchemaFields\StringField($name.'__pickup__option__@orderBefore', [
                        'required' => false,
                    ...
                    'orderAfter' => new SchemaFields\StringField($name.'__pickup__@orderAfter', [
                        'required' => false,
