...
namespace Local\Core\Inner\TradingPlatform\Handler\Ekatalog;
...
<div class="blockquote-footer">e-katalog</div>
</div>
...
<br/>
<b>Внимание!</b><br/>
<i class="font-weight-bold">e-katalog</i> требует передавать стоимость товара в одной валюте. Ввиду этого, если значением поля <b>"Конвертация цен"</b> является <b>"Оставлять цены в переданных валютах"</b>, то мы будет вынуждены конвертировать все цены в основную валюту торговой площадки. Для <i class="font-weight-bold">e-katalog</i> основной валютой является <b>$strDefaultCurrencyCode</b>.
DOCHERE
            ));
