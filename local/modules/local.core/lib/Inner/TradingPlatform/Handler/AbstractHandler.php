...
Если курсы данного сервиса Вам не устраивают, Вы можете самостоятельно произвести конвертацию валюты товаров, передать их в Robofeed XML и выбрать в данном поле <b>"Оставлять цены в переданных валютах"</b>.<br/>
<br/>
<b>Внимание!</b> Некоторые торговые площадки могут не поддерживать передаваемую Вами валюту. В таких случаях мы будем вынуждены принудительно переконвертировать валюту товара и стоимость в валюту, которую торговая площадка считает основной, либо если такой нет - в Российский рубль.<br/>
<br/>Списком доступных валют для выбранной торговой площадки являются варианты значенией текущего поля.
$strMainCurrency
DOCHERE
                )),
