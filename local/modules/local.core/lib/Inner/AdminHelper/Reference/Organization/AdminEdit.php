    ...
    protected function getTabsContent()
    {
        ...
        return [
            "main" => [
                ...
                ( new \Local\Core\Inner\AdminHelper\EditField\Select($columnName["APPROVED"], "APPROVED") )->setEditable($canEdit)->setVariants(self::$approved_values),

                ( new \Local\Core\Inner\AdminHelper\EditField\Text($columnName['NAME'], 'NAME') )->setEditable($canEdit)->setRequired(true),

                ( new \Local\Core\Inner\AdminHelper\EditField\Text($columnName['OPF'], 'OPF') )->setEditable($canEdit)->setRequired(true),

                ( new \Local\Core\Inner\AdminHelper\EditField\Text($columnName['INN'], 'INN') )->setEditable($canEdit)->setRequired(true),

                ( new \Local\Core\Inner\AdminHelper\EditField\Text($columnName['KPP'], 'KPP') )->setEditable($canEdit)->setRequired(true),

                ( new \Local\Core\Inner\AdminHelper\EditField\Text($columnName['LEGAL_ADDRESS'], 'LEGAL_ADDRESS') )->setEditable($canEdit)->setRequired(true),

                ( new \Local\Core\Inner\AdminHelper\EditField\Text($columnName['POST_ADDRESS'], 'POST_ADDRESS') )->setEditable($canEdit)->setRequired(true),

                ( new \Local\Core\Inner\AdminHelper\EditField\Text($columnName['BANK'], 'BANK') )->setEditable($canEdit)->setRequired(true),

                ( new \Local\Core\Inner\AdminHelper\EditField\Text($columnName['BIK'], 'BIK') )->setEditable($canEdit)->setRequired(true),

                ( new \Local\Core\Inner\AdminHelper\EditField\Text($columnName['RSCH'], 'RSCH') )->setEditable($canEdit)->setRequired(true),

                ( new \Local\Core\Inner\AdminHelper\EditField\Text($columnName['FAX'], 'FAX') )->setEditable($canEdit)->setRequired(true),

                ( new \Local\Core\Inner\AdminHelper\EditField\Date($columnName["DATE_INSERT"], "DATE_INSERT") )->setEditable(false),

                ( new \Local\Core\Inner\AdminHelper\EditField\Date($columnName["TIMESTAMP_X"], "TIMESTAMP_X") )->setEditable(false),
            ]
        ];
    }
