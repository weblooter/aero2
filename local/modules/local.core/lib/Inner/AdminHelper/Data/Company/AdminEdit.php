        ...
        return [
            "main" => [
                ( (int)$this->id > 0 ) ? new \Local\Core\Inner\AdminHelper\EditField\Html( $columnName[ "ID" ], "ID",
                    $this->id ) : null,
                ( (int)$this->id > 0 ) ? new \Local\Core\Inner\AdminHelper\EditField\Hidden( "", "ID",
                    $this->id ) : null,
                ...
                ( new \Local\Core\Inner\AdminHelper\EditField\Textarea( $columnName[ 'VERIFIED_NOTE' ],
                    'VERIFIED_NOTE' ) )
                    ->setEditable( $canEdit )
                    ->setRequired( true ),
            ],
            ...
            'ur_data' => [
                ...
                ( new \Local\Core\Inner\AdminHelper\EditField\Text( $columnName[ 'COMPANY_NAME_SHORT' ],
                    'COMPANY_NAME_SHORT' ) )
                    ->setEditable( $canEdit )
                    ->setRequired( true ),

                ( new \Local\Core\Inner\AdminHelper\EditField\Text( $columnName[ 'COMPANY_NAME_FULL' ],
                    'COMPANY_NAME_FULL' ) )
                    ->setEditable( $canEdit )
                    ->setRequired( true ),
                ...
                ( new \Local\Core\Inner\AdminHelper\EditField\Text( $columnName[ 'COMPANY_DIRECTOR' ],
                    'COMPANY_DIRECTOR' ) )
                    ->setEditable( $canEdit )
                    ->setRequired( true ),

                ( new \Local\Core\Inner\AdminHelper\EditField\Text( $columnName[ 'COMPANY_ACCOUNTANT' ],
                    'COMPANY_ACCOUNTANT' ) )
                    ->setEditable( $canEdit )
                    ->setRequired( true ),
            ],
            ...
            'ur_address' => [
                ( new \Local\Core\Inner\AdminHelper\EditField\Text( $columnName[ 'COMPANY_ADDRESS_COUNTRY' ],
                    'COMPANY_ADDRESS_COUNTRY' ) )
                    ->setEditable( $canEdit )
                    ->setRequired( true ),

                ( new \Local\Core\Inner\AdminHelper\EditField\Text( $columnName[ 'COMPANY_ADDRESS_REGION' ],
                    'COMPANY_ADDRESS_REGION' ) )
                    ->setEditable( $canEdit )
                    ->setRequired( true ),

                ( new \Local\Core\Inner\AdminHelper\EditField\Text( $columnName[ 'COMPANY_ADDRESS_AREA' ],
                    'COMPANY_ADDRESS_AREA' ) )
                    ->setEditable( $canEdit )
                    ->setRequired( true ),

                ( new \Local\Core\Inner\AdminHelper\EditField\Text( $columnName[ 'COMPANY_ADDRESS_CITY' ],
                    'COMPANY_ADDRESS_CITY' ) )
                    ->setEditable( $canEdit )
                    ->setRequired( true ),

                ( new \Local\Core\Inner\AdminHelper\EditField\Text( $columnName[ 'COMPANY_ADDRESS_ADDRESS' ],
                    'COMPANY_ADDRESS_ADDRESS' ) )
                    ->setEditable( $canEdit )
                    ->setRequired( true ),

                ( new \Local\Core\Inner\AdminHelper\EditField\Text( $columnName[ 'COMPANY_ADDRESS_OFFICE' ],
                    'COMPANY_ADDRESS_OFFICE' ) )
                    ->setEditable( $canEdit )
                    ->setRequired( true ),

                ( new \Local\Core\Inner\AdminHelper\EditField\Text( $columnName[ 'COMPANY_ADDRESS_ZIP' ],
                    'COMPANY_ADDRESS_ZIP' ) )
                    ->setEditable( $canEdit )
                    ->setRequired( true ),
            ]
