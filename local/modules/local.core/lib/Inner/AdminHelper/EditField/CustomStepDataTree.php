        ...
        if (!$isMultiple) {
            if ($setReload) {
                $this->strHtml .= str_replace(
                        ...
                        SelectBoxFromArray($code, ['reference' => array_values($ar), 'reference_id' => array_keys($ar)], $val, $defaultText)
                    ) . ' ';
            }
            else {
                $this->strHtml .= SelectBoxFromArray($code, ['reference' => array_values($ar), 'reference_id' => array_keys($ar)], $val, $defaultText) . ' ';
            }
        }
        else {
            if ($setReload) {
                $this->strHtml .= str_replace(
                        ...
                        SelectBoxMFromArray($code . '[]', ['reference' => array_values($ar), 'reference_id' => array_keys($ar)], $val, $defaultText)
                    ) . ' ';
            }
            else {
                $this->strHtml .= str_replace(
