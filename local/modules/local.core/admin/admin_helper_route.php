 ...
 * "код_страницы" => [
 *    "действие" => Исполняемый класс унаследованный от \Local\Core\Inner\AdminHelper\EditBase или \Local\Core\Inner\AdminHelper\ListBase
 * ]
 */
$arRouteRules = [
...
if (
    isset($entity) && isset($arRouteRules[$entity])
    && isset($arRouteRules[$entity][$action])
    && class_exists($arRouteRules[$entity][$action])
) {
